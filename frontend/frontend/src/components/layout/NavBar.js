...
class Navbar extends Component {
  ...
  render () {
    ...
    const authLinkO = (
      <div className='d-flex justify-content-between align-content-end col-md-12'>
        ...
        <div className="row col-md-4 d-flex justify-content-end align-items-center" style={{color:'white'}}>
          ...
          />
          <h3 style={{color:'#00f500'}}>L</h3><h3>O</h3><h3 style={{color:'#00f500'}}>R</h3>
          <h3>{' '}T</h3><h3 style={{color:'#00f500'}}>r</h3><h3>a</h3>
          <h3 style={{color:'#00f500'}}>c</h3><h3>k</h3><h3 style={{color:'#00f500'}}>e</h3><h3>r</h3>
        </div>
      </div>
    ...
    return (
      <nav className="navbar navbar-expand-sm  col-md-12 " style={{background:'#0091e9'}}>
